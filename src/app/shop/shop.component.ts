...
export class ShopComponent implements OnInit {
  ...
  private apiUrl = 'http://localhost:3000/api/products';  // Define apiUrl property
  private categoriesUrl = 'http://localhost:3000/api/products/categories';  // Define categoriesUrl property
